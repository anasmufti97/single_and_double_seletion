...
import 'package:practice1/multiple_selection_screen.dart';
              ...
              Column(
                  children:
                      List.generate(7, (index) => InkWell(
                          ...
                          child: singleSelectionContainer(color: changeColor!=index ?Colors.red : green)))),
              changeColor!=-1?InkWell(
                  onTap: (){

                    Get.to(MultipleSelectionScreen());
